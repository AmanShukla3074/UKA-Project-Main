...
class ArtistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Artist_M
        fields = ['Artist_ID', 'Bio', 'Artist_Name', 'Date_Joined', 'MS_Genre_ID','User_ID']
...
class AlbumSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Album_M
        fields = ["Album_ID","Album_Title","ReleaseDate","No_Of_Songs","Copyrightowner","MS_Genre_ID","Music","album_artist","Artist"]
